...
export const Product = motion(forwardRef<HTMLDivElement, ProductProps>(({product, className, ...props}: ProductProps, ref): JSX.Element => {
  ...
  return (
    <motion.div layout layoutId={product._id} className={className} ref={ref} {...props}>
        <Card className={styles.product} color="white">
            ...
            <div className={styles.actions}>
                ...
                <Button appearance="ghost" arrow={isReviewOpened ? "down": "right"} onClick={() => {setIsReviewOpened(!isReviewOpened)}} className={styles.reviewButton}>Читать отзывы</Button>
            </div>
        </Card>
        <motion.div variants={variants} initial={isReviewOpened ? "opened" : "closed"} animate={isReviewOpened ? "opened" : "closed"}>
